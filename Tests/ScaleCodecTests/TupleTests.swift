...
final class TupleTests: XCTestCase {
    ...
    func testTuple2() {
        do {
            let d1 = try SCALE.default.encode((UInt8.min, UInt8.max))
            XCTAssertEqual(d1.hex, "00 ff")
            let t1 = try SCALE.default.decode((UInt8, UInt8).self, from: d1)
    ...
    func testTuple3() {
        do {
            let d1 = try SCALE.default.encode((UInt8.min, UInt8(128), UInt8.max))
            XCTAssertEqual(d1.hex, "00 80 ff")
            let t1 = try SCALE.default.decode((UInt8, UInt8, UInt8).self, from: d1)
            XCTAssertEqual(t1.0, UInt8.min)
    ...
    func testTuple4() {
        do {
            let d1 = try SCALE.default.encode((UInt8.min, UInt8(127), UInt8(128), UInt8.max))
            XCTAssertEqual(d1.hex, "00 7f 80 ff")
            let t1 = try SCALE.default.decode((UInt8, UInt8, UInt8, UInt8).self, from: d1)
            XCTAssertEqual(t1.0, UInt8.min)
    ...
    func testTuple5() {
        do {
            let d1 = try SCALE.default.encode((UInt8.min, UInt8(127), UInt8(128), UInt8(129), UInt8.max))
            XCTAssertEqual(d1.hex, "00 7f 80 81 ff")
            let t1 = try SCALE.default.decode((UInt8, UInt8, UInt8, UInt8, UInt8).self, from: d1)
            XCTAssertEqual(t1.0, UInt8.min)
            XCTAssertEqual(t1.1, 127)
            XCTAssertEqual(t1.2, 128)
    ...
    func testTupleNestedContainers() {
        do {
            let d1 = try SCALE.default.encode(
                (
            ...
            let t1 = try SCALE.default.decode(
